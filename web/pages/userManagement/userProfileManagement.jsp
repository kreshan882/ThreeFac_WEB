    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function taskassineformatter(cellvalue, options, rowObject) {
                return "<a href='#' onClick='javascript:assineTaskNow(&#34;" + cellvalue + "&#34;)'><img src ='${pageContext.request.contextPath}/resources/images/iconTask.png' /></a>";
            }
            ...
            function toleft() {
                if (  jQuery.type($("#newBox option:selected").val()) !== "undefined") {
                    ...
                    $("#newBox option:selected").each(function () {
                        ...
                        $("#errorbox").html('<br><b><font size="3" color="red"><center>Please select task ');
                    }
                }


                function toright() {
                    if (jQuery.type($("#currentBox option:selected").val()) !== "undefined") {
                    ...
                    <s:set var="vresetpass"><s:property value="vresetpass" default="true"/></s:set>
                        ...
                        <s:form id="taskasinForm"  theme="simple" method="post" cssStyle="display:none" >
                            <table class="form_table">
                                ...
                                <tr></tr>
                                <tr>
                                    <td  colspan="0" class="formLable">Not Selected Task</td> <td></td>
                                    <td></td>                           
                                    <td ></td>
                                    <td colspan="0"  class="formLable">Selected Task</td> <td></td>
                                    <td></td>
                                </tr> 
                            </table><table class="form_table">
                                <tr>
            ...
            <div class="viewuser_tbl">
                <div id="tablediv">
                    ...
                    <sjg:grid
                        ...
                        <sjg:gridColumn name="profileId" index="PROFILE_ID" title="Edit Status" align="center" width="7" align="center"  formatter="editformatter" sortable="false" hidden="#vupdate"/>
