...
/////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////
    public static final String CUSTRA_NIC_EMPTY = "Empty NIC ";
    ...
    public static final String CUSTRA_TRANSACTION_SUCCESS = "Customer transaction submitted ";
    ...
    public static final String CUSTRA_TRANSACTION_NOACCOUNT = "Customer NIC not found";
    
    public static final String CUSTRA_ACCOUNT_NUMBER_SELECT = "Select account number ";
    ...
    public static final String CUST_INVALID_OPTION = "Invalid registration category";
    ...
    public static final String CUST_NICPP_INVALID = "Invalid NIC or Passport Number";
    public static final String CUST_MOBILE_DUPLICATE = "Already registered customer";
    ...
    public static final String CUST_DELETED_ERROR = "Customer delete unauthorized";
    ...
    public static final String CUSTRISKPROMGMNT_MSGDELMODEORDER_SELECT = "Select message delivery mode order ";
    public static final String CUSTRISKPROMGMNT_CHARGESMODE_SELECT = "Select charges mode ";
    public static final String CUSTRISKPROMGMNT_MSGVALIDITYPERIOD_SELECT = "Select massege validity period";
    public static final String CUSTRISKPROMGMNT_GLOBAL_AMOUNT_EMPTY = "Empty global amount";
    ...
    public static final String CUSTRISKPROMGMNT_FEECALCMETHOD_SELECT = "Select fee calculation method";
    public static final String CUSTRISKPROMGMNT_MSGDELMODESEC_SELECT = "Select message delivery mode sec";
    ...
    public static final String CUSTRISKPROMGMNT_GLOBAL_AMOUNT_INVALID = "Invalid global amount";
    public static final String CUSTRISKPROMGMNT_MSGVALIDITYPERIOD_INVALID = "Invalid massege validity period";
    public static final String CUSTRISKPROMGMNT_NOOFTXNALLOWEDPERRECIPIENT_INVALID = "Invalid number of transactions allowed per recipient";
    ...
    public static final String SMS_PROF_DELETED_ERROR = "SMS profile delete unauthorized";
    ...
    public static final String SMS_TEMP_DELETED_ERROR = "SMS template delete unauthorized";
    ...
    public static final String LISTENER_READTIMEOUT_INVALID = "Invalid read timeout";
    ...
    //LOG MANAGEMENT
    /////////////////////////////////////////////////////////////////////////////////
    public static final String LOG_UPDATE_SUCCESS = "Log level update successful";
    public static final String LOG_UPDATE_ERROR = "Log level update error";

    public static final String LOG_DOWNLOAD_SUCCESS = "Log downloaded successfully";
    ...
    public static final String PASSPOLICY_MINNUMERICALCHARS_EMPTY = "Empty minimum numerical characters";
    public static final String PASSPOLICY_MINNUMERICALCHARS_INVALID = "Invalid minimum numerical characters";
    ...
    public static final String SYSPARAMETER_NOF_LOG_FILE_EMPTY = "Empty no of log file";
    public static final String SYSPARAMETER_NOF_LOG_FILE_INVALID = "Invalid no of log file";
    ...
    public static final String BULK_MSG_RECIPIENT_MOBILE_DUPLICATE = "Mobile number already exist";
    ...
    public static final String BULK_MSG_ADD = "Bulk massage add successful";
    public static final String BULK_MSG_ADD_FAIL = "Bulk massage add fail";

    public static final String BULK_MSG_SEND_SUCCESSFULY = "Bulk massages sent";
    public static final String BULK_MSG_SEND_FAIL = "Bulk massages send fail";

    public static final String BULK_MSG_DELETED = "Massage deleted";
    public static final String BULK_MSG_DELETED_FAIL = "Massage delete fail";
    
    public static final String BULK_FILEUPLOAD_SUCCESS = "File upload successfull";
    public static final String BULK_FILEUPLOAD_FAIL = "File upload fail";
     public static final String BULK_FILE_TYPE_WRONG = "File type error";
