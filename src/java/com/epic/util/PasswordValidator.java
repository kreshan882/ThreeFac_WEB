...
//
//                        } else {
//                            return " insert minimum " + passPolcyBean.getMinimumnumericalcharacters() + " numeric values";
//                        }
//
//                    } else {
//                        return " insert minimum " + passPolcyBean.getMinimumuppercasecharacters() + " uppercase values";
//                    }
//
//                } else {
//                    return " insert special character count between ( " + passPolcyBean.getMinimumspecialcharacters() + " , " + passPolcyBean.getMaximumspecialcharacters() + " ) : Allowed characters ( " + passPolcyBean.getAllowspecialcharacters() + " ) ";
//                }
//
//            } else {
