...
//                                boolean status = false;
           ...
           System.out.println("Class:"+className+"    Method:"+method+"   Msg:"+DBConnection.checkDBPoolStatus());
           LogFileCreator.writeInfoToLog("Class:"+className+"    Method:"+method+"   Msg:"+DBConnection.checkDBPoolStatus());
